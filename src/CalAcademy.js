...
export function CalAcademy(props) {
  return (
    <div className="puzzle CalAcademy">
      ...
      <p>
        Goldan Gate Park just celebrated it's 150-year-old birthday. It's home to historic stuff
        like the Conservatory of Flowers (opened 1879). Even living things like bison since 1891.
        There's newer stuff like the Hardly Strickly Bluegrass Festival and the California Academy of
        Science. There's a funny story about a puzzle hunt at the 
        {' '}
        ...
        {' '}
        where the a globe of solid gold was to be the prize for the puzzle hunt. It would have been
        worth $32 billion.  Historians however doubt that the story is real.
      </p>
      <p>
        ...
        cylinder. He used it for a decade until earlier this year when he was in for a surprise.  Mr
        Döggflava slammed the door too hard, broke the cylinder, and it revealed a piece of paper
        inside. Mr.  Döggflava thinks the note is a visitor's list of attractions from some past
